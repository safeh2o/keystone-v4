...
Spec](https://github.com/safeh2o/keystone-v4/blob/master/admin/server/api/Readme.md))
...
- [The Storage API](https://github.com/safeh2o/keystone-v4/tree/master/lib/storage)
- [Local FileSystem Adapter](https://github.com/safeh2o/keystone-v4/blob/master/lib/storage/adapters/fs)
- [Azure Storage Adapter](https://github.com/safeh2o/keystone-v4-storage-adapter-azure)
- [S3 Storage Adapter](https://github.com/safeh2o/keystone-v4-storage-adapter-s3)

For the full upgrade guide for File fields, see
[File-Fields-Upgrade-Guide](https://github.com/safeh2o/keystone-v4/wiki/File-Fields-Upgrade-Guide)
