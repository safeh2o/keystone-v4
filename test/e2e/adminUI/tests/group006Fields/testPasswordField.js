...
module.exports = {
	// '@disabled': true,  // TODO: enable after https://github.com/safeh2o/keystone-v4/issues/3428 is fixed
	...
	"Password field should show correctly in the initial modal": function (
		browser
	) {
		...
		browser.adminUIInitialFormScreen.fillFieldInputs({
			fields: [
				{ name: "name", input: { value: "Password Field Test 1" } },
				{
					name: "fieldA",
					input: {
						value: "CorrectH0rseB@tteryStapl1",
						confirm: "wrongCorrectH0rseB@tteryStapl1",
					},
				},
			],
		});
		browser.adminUIInitialFormScreen.save();
		browser.adminUIInitialFormScreen.assertElementTextEquals({
			element: "@flashError",
			...
			fields: [
				{
					...
					input: {
						value: "CorrectH0rseB@tteryStapl1",
						confirm: "CorrectH0rseB@tteryStapl1",
					},
				},
			],
		});
			...
			fields: [
				{
					name: "fieldB",
					input: {
						value: "CorrectH0rseB@tteryStapl2",
						confirm: "wrongCorrectH0rseB@tteryStapl2",
					},
				},
			],
		});
			...
			fields: [
				{
					...
					input: {
						value: "CorrectH0rseB@tteryStapl2",
						confirm: "CorrectH0rseB@tteryStapl2",
					},
				},
			],
		});
