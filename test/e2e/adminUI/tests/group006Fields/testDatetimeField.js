...
module.exports = {
	//'@disabled': true, // TODO:  https://github.com/safeh2o/keystone-v4/issues/3330
	...
	"Datetime field should show correctly in the initial modal": function (
		browser
	) {
	...
	"Datetime field can be filled via the initial modal": function (browser) {
		...
		browser.adminUIInitialFormScreen.fillFieldInputs({
			fields: [
				...
				/* https://github.com/safeh2o/keystone-v4/issues/3330
	...
	"Datetime field should show correctly in the edit form": function (browser) {
		browser.adminUIItemScreen.assertFieldUIVisible({
			fields: [{ name: "name" }, { name: "fieldA" }, { name: "fieldB" }],
		});
