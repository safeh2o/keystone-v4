...
function localfiles(list, path, options) {
	throw new Error(
		"The LocalFiles field type has been removed. Please use File instead." +
			"\n\nSee https://github.com/safeh2o/keystone-v4/wiki/File-Fields-Upgrade-Guide\n"
	);
 ...
 * Deprecated
 */
localfiles.prototype.inputIsValid = function (data) {
 ...
 */
localfiles.prototype.updateItem = function (item, data, callback) {
	// eslint-disable-line no-unused-vars
	...
	return function () {
		...
		if (req.body[paths.order]) {
			...
			files.sort(function (a, b) {
				return newOrder.indexOf(a._id.toString()) >
					newOrder.indexOf(b._id.toString())
					? 1
					: -1;
			});
		}
